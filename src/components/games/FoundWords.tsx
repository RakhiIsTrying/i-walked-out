...
export default function FoundWords({ words, allLetters }: FoundWordsProps) {
  ...
  return (
    <div style={{
      ...
      borderTop: "1.5px dashed var(--ink-3)", paddingTop: 12, marginTop: 4,
    }}>
          ...
          return (
            <span
              ...
              style={{
                ...
                background: isPangram ? "var(--note-1)" : "var(--paper-deep)",
                border: isPangram ? "2px solid var(--ink)" : "1px solid var(--ink-3)",
