  ...
  return (
    <div style={{ marginTop: 48 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
        <span style={{ fontFamily: "var(--mono)", fontSize: 11, letterSpacing: "0.12em", textTransform: "uppercase", color: "var(--ink-3)" }}>
          past vibes
        </span>
        ...
        {history.slice(1).map((h, i) => (
          <button
            ...
            style={{
              ...
              borderRadius: 3, fontSize: 19, color: "var(--ink-2)",
              transition: "background 0.2s ease",
            }}
          >
            &ldquo;{h.query}&rdquo;
            {h.vibe_summary && (
              <span style={{ marginLeft: 10, fontSize: 14, color: "var(--ink-3)", fontFamily: "var(--serif)" }}>
