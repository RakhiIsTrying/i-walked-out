      ...
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        >
          ...
          <div className="typewriter" style={{ fontSize: 10, letterSpacing: "0.2em", textTransform: "uppercase", color: "var(--ink-faded)", marginBottom: 20, textAlign: "center" }}>
            ✦ daily {GAMES.find((g) => g.id === active)?.label} ✦
          </div>
          ...
          {loading ? (
            ...
            <>
              {active === "wordle" && <WordleGame answer={puzzles?.wordle?.answer} />}
              {active === "sudoku" && <SudokuGame puzzle={puzzles?.sudoku} />}
              {active === "spelling" && <SpellingBeeGame puzzle={puzzles?.spelling} />}
              {active === "crossword" && <CrosswordGame puzzle={puzzles?.crossword} />}
            </>
          )}
        </div>
