    ...
    <div style={{ display: "flex", minHeight: "80vh", alignItems: "center", justifyContent: "center", padding: "40px 20px" }}>
      <div style={{ width: "100%", maxWidth: 440 }}>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          >
            Welcome back, <em style={{ color: "var(--accent)" }}>ghost.</em>
          </h1>
        ...
        {mode === "email" ? (
          <form onSubmit={handleEmailLogin} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <input type="password" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)} style={{ width: "100%", paddingLeft: 36 }} required />
            </div>
            {error && (
        ...
        <p style={{ marginTop: 24, textAlign: "center", fontFamily: "var(--serif)", fontStyle: "italic", fontSize: 15, color: "var(--ink-2)" }}>
          No account yet?{" "}
          <Link href="/auth/signup" style={{ color: "var(--accent)", borderBottom: "1px solid var(--accent)" }}>Join the graveyard</Link>
        </p>
      </div>
    </div>
  );
